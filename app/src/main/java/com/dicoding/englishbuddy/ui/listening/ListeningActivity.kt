...
import com.dicoding.englishbuddy.data.QuestionListening
import java.io.IOException

class ListeningActivity : AppCompatActivity(), View.OnClickListener {

    private var mCurrentPosition: Int = 1
    private var mQuestionList: ArrayList<QuestionListening>? = null
    ...
    fun setQuestionList() {
        ...
        mQuestionList?.let {
            ...
            val question : QuestionListening = questionsList[currentPosition - 1]
...
//                                    Toast.makeText(this,"Congratulation you made to the end",Toast.LENGTH_LONG).show()
                                    val intent = Intent(this,ResultListeningActivity::class.java)
    ...
    private fun init(question: QuestionListening) {
        ...
        mediaPlayer?.setDataSource(applicationContext, Uri.parse("android.resource://${packageName}/${question.audio}"))
